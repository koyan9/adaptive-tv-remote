...
- `docs/ROADMAP.md` — phase-based evolution plan
- `docs/REPOSITORY-READY.md` — extraction and repository-readiness notes
- `docs/EXTRACTION.md` — standalone repo extraction guide
- `docs/GITHUB-METADATA.md` — GitHub repository metadata suggestions
