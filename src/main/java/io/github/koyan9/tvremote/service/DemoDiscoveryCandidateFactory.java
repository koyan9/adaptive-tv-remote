    ...
    public List<CandidateDeviceEntity> candidates(HouseholdEntity household) {
        return List.of(
                ...
                new CandidateDeviceEntity(
                        ...
                        false,
                        "Study BRAVIA",
                        "Discovered on Wi-Fi and should go through Sony BRAVIA onboarding.",
                        "demo-sony-scan",
                        CandidateStatus.DISCOVERED,
                        null,
                        Instant.now()
                ...
                new CandidateDeviceEntity(
                        ...
                        false,
                        "Family Room TCL",
                        "Detected via infrared gateway scan. Needs IR profile binding.",
                        "demo-gateway-scan",
                        CandidateStatus.DISCOVERED,
                        null,
                        Instant.now()
